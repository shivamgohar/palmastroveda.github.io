			...
			<div class="row">
				...
				<div class="col-sm-6">
					<div class="about_images wow slideInRight">
						<img src="assets/image/silder/slider1 (5).jpg" width="100%" alt="silder images" title="silder images">
					</div>
				</div>
			</div>
		</div>
			...
			<div class="row">
				<div class="col-sm-4">
					<div class="services_matter">
						...
						<h4 class="wow fadeInDown animated"><a href="full_services_page.php">Kundli Dosha</a></h4>
						<p class="wow fadeInDown animated">Contrary to popular belief, Lorem Ipsum is not simply random text</p>
						<a href="full_services_page.php" class="btn wow fadeInDown animated">Read More</a>
					</div>
				</div>
				...
				<div class="col-sm-4">
					<div class="services_matter">
						...
						<h4 class="wow fadeInDown animated" ><a href="full_services_page.php">Personal Consultation</a></h4>
						<p class="wow fadeInDown animated" >Contrary to popular belief, Lorem Ipsum is not simply random text</p>
						<a href="full_services_page.php" class="btn wow fadeInDown animated">Read More</a>
					</div>
				</div>
				...
				<div class="col-sm-4">
					<div class="services_matter">
						...
						<h4 class="wow fadeInDown animated"><a href="full_services_page.php">Face Reading</a></h4>
						<p class="wow fadeInDown animated">Contrary to popular belief, Lorem Ipsum is not simply random text</p>
						<a href="full_services_page.php" class="btn wow fadeInDown animated">Read More</a>
					</div>
				</div>
